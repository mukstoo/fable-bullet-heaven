...
export const WAVE_PHASES: WavePhase[] = [
  ...
  { tStart: 210, spawnIntervalMs: 410, maxAlive: 125, pool: [{ type: 'zombie', weight: 4 }, { type: 'spider', weight: 4 }, { type: 'skeleton', weight: 3 }, { type: 'cultist', weight: 3 }] },
  { tStart: 270, spawnIntervalMs: 370, maxAlive: 145, pool: [{ type: 'spider', weight: 4 }, { type: 'ghost', weight: 3 }, { type: 'zombie', weight: 3 }, { type: 'cultist', weight: 3 }] },
